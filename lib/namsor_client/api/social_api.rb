...
module NamSorClient
  class SocialApi
    ...
    def phone_prefix(first_name, last_name, phone_number, opts = {})
      data, _status_code, _headers = phone_prefix_with_http_info(first_name, last_name, phone_number, opts)
      data
    end
    ...
    def phone_prefix_with_http_info(first_name, last_name, phone_number, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SocialApi.phone_prefix ...'
      end
      # verify the required parameter 'first_name' is set
      if @api_client.config.client_side_validation && first_name.nil?
        fail ArgumentError, "Missing the required parameter 'first_name' when calling SocialApi.phone_prefix"
      end
      # verify the required parameter 'last_name' is set
      if @api_client.config.client_side_validation && last_name.nil?
        fail ArgumentError, "Missing the required parameter 'last_name' when calling SocialApi.phone_prefix"
      end
      # verify the required parameter 'phone_number' is set
      if @api_client.config.client_side_validation && phone_number.nil?
        fail ArgumentError, "Missing the required parameter 'phone_number' when calling SocialApi.phone_prefix"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SocialApi#phone_prefix\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def phone_prefix_batch(opts = {})
      data, _status_code, _headers = phone_prefix_batch_with_http_info(opts)
      data
    end
    ...
    def phone_prefix_batch_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SocialApi.phone_prefix_batch ...'
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SocialApi#phone_prefix_batch\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
