  ...
  class ExpectedClassMetricsOut
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NamSorClient::ExpectedClassMetricsOut` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NamSorClient::ExpectedClassMetricsOut`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'expected_class')
        self.expected_class = attributes[:'expected_class']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          expected_class == o.expected_class &&
    ...
    def hash
      [classifier_name, expected_class, ai_estimate_total, ai_estimate_precision, ai_estimate_recall, ai_learn_total].hash
    end
